...
class MedicalDataset(Dataset):
    ...
    def __init__(self, data_path, num_class=17, max_length=100, use_tfidf=False, simple_feature=None):
...
class MedicalDatasetEasyEnsemble(Dataset):
    ...
    def __init__(self, data_path, class_id, max_length=100, use_tfidf=False, simple_feature=None):
    ...
    def re_sample(self):
        sample_negative_index = np.random.choice(len(self.negative_corpus), len(self.positive_corpus), replace=False)
...
class MedicalTestDataset(Dataset):
    ...
    def __init__(self, data_path, max_length=100, use_tfidf=False, simple_feature=None):
...
class MedicalDataloader(DataLoader):
    ...
    def __init__(self, data_path, num_class, batch_size, shuffle, num_worker, use_tfidf=False, simple_feature=None):
        dataset = MedicalDataset(data_path, num_class, use_tfidf=use_tfidf, simple_feature=simple_feature)
...
class MedicalTestDataloader(DataLoader):
    ...
    def __init__(self, data_path, batch_size, num_worker, use_tfidf=False, simple_feature=None):
        dataset = MedicalTestDataset(data_path, use_tfidf=use_tfidf, simple_feature=simple_feature)
...
class MedicalEasyEnsembleDataloader(DataLoader):
    ...
    def __init__(self, data_path, class_id, batch_size, shuffle, num_worker, use_tfidf=False, simple_feature=None):
        dataset = MedicalDatasetEasyEnsemble(data_path, class_id, use_tfidf=use_tfidf, simple_feature=simple_feature)
